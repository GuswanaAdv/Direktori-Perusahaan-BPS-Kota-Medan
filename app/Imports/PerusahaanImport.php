...
class PerusahaanImport implements ToModel, WithHeadingRow
{
    ...
    */
    public function model(array $row){
        // Menentukan identifier unik, misalnya id_perusahaan
        $identifier = $row['id_perusahaan'];

        // Mencari entitas dengan identifier yang sama
        $perusahaan = Perusahaan::where('id_perusahaan', $identifier)->first();

        if ($perusahaan && $identifier != "-") {
