<div class="sm:pl-2 pl-0">
    ...
    <label class="form-control w-full max-w-xs">
        ...
        <input type="text" placeholder="Provinsi" name="provinsi" class="input input-bordered w-full max-w-xs" required/>
    </label>
    ...
    <label class="form-control w-full max-w-xs">
        ...
        <input type="text" placeholder="Kabupaten" name="kabupaten" class="input input-bordered w-full max-w-xs" required/>
    </label>
    ...
    <label class="form-control w-full max-w-xs">
        ...
        <input type="text" placeholder="Kota" name="kabupaten" class="input input-bordered w-full max-w-xs" required/>
    </label>
