    ...
    <div class="flex items-center justify-center py-8">
        <div class="card bg-white sm:w-3/4 shadow-xl w-full">
            ...
            <div class="card-body w-full text-2xl text-left sm:px-20 border-b-2 font-bold">
                Perusahaan sampel yang berhasil ditambahkan
            </div>
                      ...
                      <tbody>
                        ...
                        @foreach ($perusahaanSementaras as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('perusahaan-view',['id_perusahaan' => $row->id_perusahaan])}}"
            ...
            <div class="card-body text-2xl text-left sm:px-20 font-bold">
                <div class="w-30 flex items-center justify-end sm:mr-20 mb-8">
                    <a href="{{route('perusahaan-cari-tambah',['id_pembaruan' => $id_pembaruan])}}"
